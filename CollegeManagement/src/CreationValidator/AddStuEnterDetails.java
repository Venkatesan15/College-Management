...
public class AddStuEnterDetails {
    ...
    public String enterRollNumber()
    {
        ...
        if(addOrGetStudentsMLObj.isRollNumberOrNameExists(rollNumber))
        {
    ...
    public String enterName()
    {
        ...
        if(AddStuCreationValidator.checkValidName(name))
        {
            if(addOrGetStudentsMLObj.isRollNumberOrNameExists(name))
            {
    ...
    public String enterGender()
    {
        ...
        gender= GetOnlyInt.onlyInt();
        if(AddStuCreationValidator.checkValidGender(gender))
        {
            if(gender==1) {
                return "Male";
            }
    ...
    public String enterPhoneNumber()
    {
        ...
        boolean isValidPhNo= AddStuCreationValidator.isPhNoHaveTenDigit(phoneNumber);
        if(isValidPhNo) {
            return phoneNumber;
        }
        else
    ...
    public String getDate()
    {
        ...
        boolean isValidDate=AddStuCreationValidator.checkValidDate(date);
        if(isValidDate)
        {
            return date;
        }
